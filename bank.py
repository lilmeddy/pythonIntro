...
for i in range(2):
    ...
    if inp == "1" :
        ...
        phone.append(num)
    print("Registration successful now let's set your login details you'll pick a username for yourself and we have some suggested user name if needed and you'll also set your password")
