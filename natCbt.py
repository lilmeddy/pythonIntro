cbt = [{"question":"1) What is my full name ","option":["a)Osamede\n","b)Osamide\n","c)Ayomide\n","d)Shush"],"correctAnswer":"a"},{"question":"2) Akinbola Righteousness Oluwatobilola is a bad person ","option":["a)Obviously, are you just knowing ire nhi\n","b)Yes he is,Ire is a bad person an I don't like him at all\n","c)I'm disappointed in you for just knowing yes he is\n","d)All of the above"],"correctAnswer":"d"},{"question":"3) Idowu Abisayo Ebun Gift is a bad person ","option":["a)Obviously bisayo is a bad person\n","b)Are you just knownin she is a very very bad person\n","c)She is my love so she is not a bad person jare\n","d)b and c\n","e)All of the above hehe "],"correctAnswer":"e"}]
correct = ["a","b","c","d","e"];score = int(0);options = ["a","b","c","d"]
...
for questions in cbt:
    ...
    if studentAns == questions["correctAnswer"]:
       score+=100;print(f"Awwn so smart you passed now you have + {score} "); print("___________________________________________________________________");print() 
    else:
        score -=50;print(f"Awwwn such an idiot you failed it hehe you can do better lol {score}"); print("________________________________________________________________");print()
meanScore = score/3     
if (meanScore >= 70):
